...
for file in os.listdir(file_list):
    ...
    if mp3 is None:
        print("\nProblem file: " + filename + ". Check that all files are mp3s.\n")
    else:
        ...
        track_list.append((mp3.tag.title, mp3.tag.artist)) #TODO when I'm bored: make it print duplicates only if they share an alubum or Unknown album
